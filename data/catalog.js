...
export const i18n = {
  az: {
    ...
    stageStepLead: "Lead",
    stageStepLeadText: "Kalkulyator sorğusu",
    stageStepCrm: "CRM",
    stageStepCrmText: "Satış statusu",
    stageStepProject: "Layihə",
    stageStepProjectText: "İcra planı",
    stageStepPortal: "Portal",
    stageStepPortalText: "Müştəri kabineti",
    stageOpsPipeline: "Pipeline",
    stageOpsBilling: "Ödənişlər",
    stageOpsRenewal: "Xatırlatma",
  ...
  en: {
    ...
    stageStepLead: "Lead",
    stageStepLeadText: "Calculator request",
    stageStepCrm: "CRM",
    stageStepCrmText: "Sales status",
    stageStepProject: "Project",
    stageStepProjectText: "Delivery plan",
    stageStepPortal: "Portal",
    stageStepPortalText: "Client workspace",
    stageOpsPipeline: "Pipeline",
    stageOpsBilling: "Billing",
    stageOpsRenewal: "Reminders",
  ...
  tr: {
    ...
    stageStepLead: "Lead",
    stageStepLeadText: "Hesaplayıcı talebi",
    stageStepCrm: "CRM",
    stageStepCrmText: "Satış durumu",
    stageStepProject: "Proje",
    stageStepProjectText: "Teslim planı",
    stageStepPortal: "Portal",
    stageStepPortalText: "Müşteri paneli",
    stageOpsPipeline: "Pipeline",
    stageOpsBilling: "Ödemeler",
    stageOpsRenewal: "Hatırlatma",
    platformEyebrow: "Platform",
  ...
  ru: {
    ...
    stageStepLead: "Лид",
    stageStepLeadText: "Заявка из калькулятора",
    stageStepCrm: "CRM",
    stageStepCrmText: "Статус продажи",
    stageStepProject: "Проект",
    stageStepProjectText: "План сдачи",
    stageStepPortal: "Портал",
    stageStepPortalText: "Кабинет клиента",
    stageOpsPipeline: "Pipeline",
    stageOpsBilling: "Платежи",
    stageOpsRenewal: "Напоминания",
