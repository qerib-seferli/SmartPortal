...
export const i18n = {
  az: {
    ...
    stageTerminalTitle: "iş otağı",
    stageEyebrow: "Canlı iş mərkəzi",
    stageTitle: "Full Stack idarəetmə paneli",
    stageText: "Satış, layihə, ödəniş və müştəri xidməti tək paneldə.",
    stageSignalOne: "Realtime baza",
    stageSignalTwo: "CRM lead axını",
    stageSignalThree: "Push bildiriş hazır",
    stageMetricModules: "modul",
    stageMetricLanguages: "dil",
    stageMetricCurrencies: "valyuta",
  ...
  en: {
    ...
    stageTerminalTitle: "work room",
    stageEyebrow: "Live work center",
    stageTitle: "Full Stack command panel",
    stageText: "Sales, projects, payments and client service in one panel.",
    stageSignalOne: "Realtime database",
    stageSignalTwo: "CRM lead flow",
    stageSignalThree: "Push ready",
    stageMetricModules: "modules",
    stageMetricLanguages: "languages",
    stageMetricCurrencies: "currencies",
  ...
  tr: {
    ...
    stageTerminalTitle: "iş odası",
    stageEyebrow: "Canlı iş merkezi",
    stageTitle: "Full Stack yönetim paneli",
    stageText: "Satış, proje, ödeme ve müşteri hizmeti tek panelde.",
    stageSignalOne: "Realtime veritabanı",
    stageSignalTwo: "CRM lead akışı",
    stageSignalThree: "Push hazır",
    stageMetricModules: "modül",
    stageMetricLanguages: "dil",
    stageMetricCurrencies: "para birimi",
    platformEyebrow: "Platform",
  ...
  ru: {
    ...
    stageTerminalTitle: "рабочая комната",
    stageEyebrow: "Живой рабочий центр",
    stageTitle: "Full Stack панель управления",
    stageText: "Продажи, проекты, платежи и клиентский сервис в одной панели.",
    stageSignalOne: "Realtime база",
    stageSignalTwo: "CRM поток лидов",
    stageSignalThree: "Push готов",
    stageMetricModules: "модулей",
    stageMetricLanguages: "языков",
    stageMetricCurrencies: "валют",
  ...
  es: { start: "Abrir calculadora", admin: "Admin ERP", portal: "Portal cliente", auth: "Entrar", heroTitle: "Plataforma global para un estudio Senior Full Stack Developer.", heroText: "Matriz multilingüe y multimoneda con 480+ opciones, CRM, ERP, portal cliente, dominios, correos, pagos y push.", matrixTitle: "Calculadora GLOBAL PRO 480+", send: "Enviar a CRM", live: "Estimación", reset: "Restablecer", notifyEnable: "Activar notificaciones", stageTerminalTitle: "sala de producción", stageEyebrow: "Centro de trabajo en vivo", stageTitle: "Panel Full Stack", stageText: "Ventas, proyectos, pagos y servicio al cliente en un panel.", stageSignalOne: "Base realtime", stageSignalTwo: "Flujo CRM", stageSignalThree: "Push listo", stageMetricModules: "módulos", stageMetricLanguages: "idiomas", stageMetricCurrencies: "monedas" },
  fr: { start: "Ouvrir le calculateur", admin: "Admin ERP", portal: "Portail client", auth: "Connexion", heroTitle: "Plateforme mondiale pour studio Senior Full Stack Developer.", heroText: "Matrice multilingue multidevise 480+ options, CRM, ERP, portail client, domaines, e-mails, paiements et push.", matrixTitle: "Calculateur GLOBAL PRO 480+", send: "Envoyer au CRM", live: "Estimation", reset: "Réinitialiser", notifyEnable: "Activer les notifications", stageTerminalTitle: "salle de production", stageEyebrow: "Centre de travail live", stageTitle: "Panneau Full Stack", stageText: "Ventes, projets, paiements et service client dans un seul panneau.", stageSignalOne: "Base realtime", stageSignalTwo: "Flux CRM", stageSignalThree: "Push prêt", stageMetricModules: "modules", stageMetricLanguages: "langues", stageMetricCurrencies: "devises" },
  de: { start: "Kalkulator öffnen", admin: "Admin ERP", portal: "Kundenportal", auth: "Login", heroTitle: "Weltklasse-Plattform für ein Senior Full Stack Developer Studio.", heroText: "Mehrsprachige Mehrwährungs-Matrix mit 480+ Optionen, CRM, ERP, Kundenportal, Domains, E-Mail, Zahlungen und Push.", matrixTitle: "GLOBAL PRO Rechner 480+", send: "An CRM senden", live: "Live-Schätzung", reset: "Zurücksetzen", notifyEnable: "Benachrichtigungen aktivieren", stageTerminalTitle: "Produktionsraum", stageEyebrow: "Live Arbeitszentrum", stageTitle: "Full Stack Steuerung", stageText: "Vertrieb, Projekte, Zahlungen und Kundenservice in einem Panel.", stageSignalOne: "Realtime Datenbank", stageSignalTwo: "CRM Leadfluss", stageSignalThree: "Push bereit", stageMetricModules: "Module", stageMetricLanguages: "Sprachen", stageMetricCurrencies: "Währungen" },
  it: { start: "Apri calcolatore", admin: "Admin ERP", portal: "Portale clienti", auth: "Accedi", heroTitle: "Piattaforma globale per studio Senior Full Stack Developer.", heroText: "Matrice multilingua e multivaluta con 480+ opzioni, CRM, ERP, portale clienti, domini, email, pagamenti e push.", matrixTitle: "Calcolatore GLOBAL PRO 480+", send: "Invia al CRM", live: "Stima live", reset: "Reimposta", notifyEnable: "Attiva notifiche", stageTerminalTitle: "sala produzione", stageEyebrow: "Centro operativo live", stageTitle: "Pannello Full Stack", stageText: "Vendite, progetti, pagamenti e clienti in un solo pannello.", stageSignalOne: "Database realtime", stageSignalTwo: "Flusso CRM", stageSignalThree: "Push pronto", stageMetricModules: "moduli", stageMetricLanguages: "lingue", stageMetricCurrencies: "valute" },
  pt: { start: "Abrir calculadora", admin: "Admin ERP", portal: "Portal cliente", auth: "Entrar", heroTitle: "Plataforma global para estúdio Senior Full Stack Developer.", heroText: "Matriz multilíngue e multimoeda com 480+ opções, CRM, ERP, portal cliente, domínios, e-mails, pagamentos e push.", matrixTitle: "Calculadora GLOBAL PRO 480+", send: "Enviar ao CRM", live: "Estimativa", reset: "Repor", notifyEnable: "Ativar notificações", stageTerminalTitle: "sala de produção", stageEyebrow: "Centro de trabalho live", stageTitle: "Painel Full Stack", stageText: "Vendas, projetos, pagamentos e atendimento em um painel.", stageSignalOne: "Base realtime", stageSignalTwo: "Fluxo CRM", stageSignalThree: "Push pronto", stageMetricModules: "módulos", stageMetricLanguages: "idiomas", stageMetricCurrencies: "moedas" },
  ar: { start: "افتح الحاسبة", admin: "إدارة ERP", portal: "بوابة العميل", auth: "تسجيل الدخول", heroTitle: "منصة عالمية لاستوديو Senior Full Stack Developer.", heroText: "مصفوفة متعددة اللغات والعملات مع أكثر من 480 خيارا وCRM وERP وبوابة عميل ودومينات وبريد ومدفوعات وتنبيهات.", matrixTitle: "حاسبة GLOBAL PRO 480+", send: "إرسال إلى CRM", live: "تقدير مباشر", reset: "إعادة ضبط", notifyEnable: "تفعيل التنبيهات", stageTerminalTitle: "غرفة الإنتاج", stageEyebrow: "مركز عمل مباشر", stageTitle: "لوحة Full Stack", stageText: "المبيعات والمشاريع والمدفوعات وخدمة العملاء في لوحة واحدة.", stageSignalOne: "قاعدة realtime", stageSignalTwo: "تدفق CRM", stageSignalThree: "Push جاهز", stageMetricModules: "وحدات", stageMetricLanguages: "لغات", stageMetricCurrencies: "عملات" },
  zh: { start: "打开计算器", admin: "Admin ERP", portal: "客户门户", auth: "登录", heroTitle: "面向 Senior Full Stack Developer 工作室的世界级平台。", heroText: "多语言、多币种、480+选项矩阵，CRM、ERP、客户门户、域名、邮箱、付款和推送提醒。", matrixTitle: "GLOBAL PRO 480+ 计算器", send: "发送到 CRM", live: "实时估算", reset: "重置", notifyEnable: "开启通知", stageTerminalTitle: "生产中心", stageEyebrow: "实时工作中心", stageTitle: "Full Stack 控制面板", stageText: "销售、项目、付款和客户服务集中在一个面板。", stageSignalOne: "实时数据库", stageSignalTwo: "CRM 线索流", stageSignalThree: "Push 已就绪", stageMetricModules: "模块", stageMetricLanguages: "语言", stageMetricCurrencies: "货币" },
  hi: { start: "Calculator खोलें", admin: "Admin ERP", portal: "Client portal", auth: "Sign in", heroTitle: "Senior Full Stack Developer studio के लिए world-class platform.", heroText: "Multilingual, multicurrency 480+ options matrix, CRM, ERP, client portal, domains, emails, payments and push reminders.", matrixTitle: "GLOBAL PRO 480+ calculator", send: "CRM को भेजें", live: "Live estimate", reset: "Reset", notifyEnable: "Notifications चालू करें", stageTerminalTitle: "production room", stageEyebrow: "Live work center", stageTitle: "Full Stack control panel", stageText: "Sales, projects, payments and client service in one panel.", stageSignalOne: "Realtime database", stageSignalTwo: "CRM lead flow", stageSignalThree: "Push ready", stageMetricModules: "modules", stageMetricLanguages: "languages", stageMetricCurrencies: "currencies" }
};
