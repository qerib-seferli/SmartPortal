...
export const i18n = {
  az: {
    ...
    auth: "Daxil ol",
    heroTitle: "Senior Full Stack Developer studiyası üçün dünya səviyyəli satış və idarəetmə platforması.",
    heroText: "Çoxdilli, çoxvalyutalı, 480+ seçimli qiymət matrisi, CRM, ERP, müştəri kabineti, domain/e-mail/ödəniş izləmə və push xatırlatma sistemi.",
    matrixTitle: "GLOBAL PRO 480+ seçim kalkulyatoru",
    send: "CRM-ə göndər",
    live: "Canlı hesab"
  },
  en: {
    ...
    auth: "Sign in",
    heroTitle: "A world-class sales and operations platform for a Senior Full Stack Developer studio.",
    heroText: "Multilingual, multicurrency pricing matrix with 480+ options, CRM, ERP, client portal, domain/email/payment tracking and push reminders.",
    matrixTitle: "GLOBAL PRO 480+ option calculator",
    send: "Send to CRM",
    live: "Live estimate"
  },
  tr: {
    ...
    auth: "Giriş yap",
    heroTitle: "Senior Full Stack Developer stüdyosu için dünya standartlarında satış ve operasyon platformu.",
    heroText: "Çok dilli, çok para birimli, 480+ seçenekli fiyat matrisi, CRM, ERP, müşteri paneli, domain/e-posta/ödeme takibi ve push hatırlatma.",
    matrixTitle: "GLOBAL PRO 480+ seçenek hesaplayıcı",
    send: "CRM'e gönder",
    live: "Canlı hesap"
  },
  ru: {
    ...
    auth: "Войти",
    heroTitle: "Платформа мирового уровня для студии Senior Full Stack Developer.",
    heroText: "Мультиязычная и мультивалютная матрица 480+ опций, CRM, ERP, кабинет клиента, домены, e-mail, платежи и push-напоминания.",
    matrixTitle: "GLOBAL PRO калькулятор 480+ опций",
